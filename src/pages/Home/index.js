...
import { fade } from "../../AnimationVariants";
...
const Home = () => {
  const aboutUsText = [{ type: "heading1", text: "About us" }];

  const welcomeMessageHeader = [
    { type: "heading1", text: "Welcome Message from the President" },
  ];

  const OurVisionHeader = [{ type: "heading1", text: "Our Vision" }];

  const OurMissionHeader = [{ type: "heading1", text: "Our Mission" }];
            ...
            <div>
              ...
              >
                <Typograpghy>
                  ...
                  Obafemi Awolowo University was established in 1972 as a group
                  of individuals admitted to study Medicine and Surgery in the
                  ...
                  <Collapsible buttonText="Read">
                    <br />
                    As a conglomeration of tomorrow’s doctors to be trained in
                    the ancient, traditional and historic town of Ife, IFUMSA
                    has continually been an association to cater for the
                    wellbeing of her community and members from the little
                    resources garnered yearly from members.
                    <br />
                    <br />
            ...
            <div className="content-row">
              ...
              <div>
                <AnimateInView initial="hidden" variants={container}>
                  ...
                  >
                    {welcomeMessageHeader.map((item, index) => {
                      return <AnimatedText {...item} key={index} />;
                    })}
                  </Typograpghy>
                </AnimateInView>
                ...
                >
                  <Typograpghy color={colors.white}>
                    ...
                    It is for a fact, an element of progressiveness to
                    understand how long we have come, to appreciate the past and
                    to welcome the future.
                    <br />
                    <br />
                    Young students, who are now our fathers and mothers,
                    pursuing the MBChB degree at the University of Ife (now
                    Obafemi Awolowo University) established an association that
                    projects their interest, represents their ideals and serve
                    their purposes. That birthed the beginning of a very long
                    but amazing journey.
                  </Typograpghy>
                  <Collapsible buttonText="Read">
                    {" "}
                    <Typograpghy color={colors.white}>
                      <>
                        ...
                        preserved. We have for ourselves an enriched culture
                        that is bathed with the values of unity, love,
                        teamspirit and nobility. Our greatest treasures are the
                        people both members and alumni who continue to
                        contribute to our successes and progress all through the
                        years. We pride ourselves as an association that is one
                        among many and second to none, this mantra we have
                        upheld for many years unshaken and without blemish.
                        <br />
                        <br />
                        Our records speak for us. We thrive to ensure that our
                        members get the most out of their medical education,
                        that as a medical student you learn more than the
                        medical rudiments but you also pick up skills that are
                        profitable in the expanse of the world and that you have
                        values that will continue to open doors. We create
                        opportunities and enabling atmosphere for growth of
                        passion, extra-curricular activities and also build
                        skills needed both within and outside medicine. As a
                        group of noble professionals in training, our core
                        objectives of academic excellence continue to be our
                        mandate while we also find time for recreational
                        activities that loosen burden.
                        <br />
                        <br />
                        Our alumni continue to be proud of what they left behind
                        and seeing us thrive is always their joy as is evident
                        by their continuous expression of satisfaction anytime
                        we have them.
                        <br />
                        <br />
                        ...
                        the future. Activities in this regard are centered
                        around the power-packed 36th Health Week and the Mega
                        Alumni Reunion Honours Day program.
                        <br />
                        <br />
                        ...
                        anniversary programs as we look forward to achieving
                        more and celebrating this great feat. Congratulations to
                        us all!
                      </>
                    </Typograpghy>
                  </Collapsible>
            ...
            <div className="content">
              <AnimateInView initial="hidden" variants={container}>
                <Typograpghy
                  ...
                  align="center"
                >
                  {OurVisionHeader.map((item, index) => {
                    return <AnimatedText {...item} key={index} />;
                  })}
                </Typograpghy>
              </AnimateInView>
              ...
              >
                <Typograpghy color={colors.primary} align="center">
                  As an affiliate member of the Nigerian Medical Association
                  (NMA) through the Nigerian Medical Students’ Association
                  (NiMSA) as well as registered member of the International
                  Federation of Medical Students’ Associations (IFMSA) and the
                  Federation Of African Medical Students’ Association (FAMSA),
                  we are committed to taking the good service of Medicine around
              ...
              <AnimateInView initial="hidden" variants={container}>
                <Typograpghy
                  ...
                  align="center"
                >
                  {OurMissionHeader.map((item, index) => {
                    return <AnimatedText {...item} key={index} />;
                  })}
                </Typograpghy>
              </AnimateInView>
              ...
              >
                <Typograpghy color={colors.primary} align="center">
                  ...
                  <br />
                  <br />
                  We not only do this to help the society, we do this to help
                  the doctor we are all going to become.
                </Typograpghy>
              </AnimateInView>
            </div>
